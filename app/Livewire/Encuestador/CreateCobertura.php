...
class CreateCobertura extends Component
{
    ...
    public function updatedFechaEncuesta($value)
    {
        if ($value && $this->asignacion_datos) {
            ...
            //$this->fecha_ip, $this->fecha_fp
            if (!$fecha_elegida->between($this->fecha_inicio, $this->fecha_fin)) {
    ...
    public function render()
    {
        ...
        return view('livewire.encuestador.create-cobertura', ['certificados' => $certificados, 'stickers' => $stickers]);
    }
}
