<div class="max-w-full rounded-md bg-white mx-auto mt-2 p-4">
    <div wire:loading>
    ...
    <div>
        <div class="mb-4 flex justify-center">
            ...
            <select class="ml-3 border border-gray-300 rounded-md" name="" id=""
                wire:model.live="fase">
        ...
        <div class="rounded-md border border-sky-500 bg-white overflow-hidden mt-4 shadow-md">
            <table class="min-w-full table-auto divide-y divide-gray-200 overflow-hidden rounded-md">
                ...
                <thead class="bg-sky-500">
                    <tr class="text-sm">
                        ...
                        <th scope="col"
                            ...
                            Cod.Sector</th>
                        <th scope="col"
                            class="px-6 py-3 text-center text-xs font-medium text-white uppercase tracking-wider">H.
                            Plan.</th>
                        <th scope="col"
                        ...
                        <th scope="col"
                            ...
                            Rech.</th>
                        <th scope="col"
                            class="px-6 py-3 text-center text-xs font-medium text-white uppercase tracking-wider">NEC
                        </th>
                        <th scope="col"
                            class="px-6 py-3 text-center text-xs font-medium text-white uppercase tracking-wider">
                            INC</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach ($plannings as $planning)
                        <tr class="text-xs hover:bg-sky-400 hover:text-white">
                            {{-- <td class="px-6 py-4 whitespace-nowrap">{{ $planning->code }}</td> --}}
