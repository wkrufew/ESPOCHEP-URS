<div class="max-w-7xl mx-auto p-6 bg-white rounded-md mt-4">
    ...
    <div>
        <h2 class="text-lg font-semibold text-center mt-3 mb-5">BUSQUEDA DE COBERTURAS POR DIA</h2>
        <div class="flex justify-center">
            <div class="py-1.5 bg-gray-200 px-2 rounded-md border border-gray-300">
