<section class="max-w-6xl mx-auto px-4 py-10">
    <x-slot name="header">
        ...
        <a href="{{ route('campo.coberturas.create') }}"
    ...
    <div class="relative overflow-x-auto">
        @if ($coberturas->count())
            <table class="w-full divide-y divide-gray-200 rounded-md table bg-white overflow-hidden shadow-md">
                                ...
                                <div class="text-sm text-gray-900">
                                    ...
                                    @if ($diffMinutes <= 24 * 60)
                                        <a class="bg-blue-500 rounded-full p-2 inline-block"
                                            href="{{ route('campo.coberturas.edit', $worker) }}">
