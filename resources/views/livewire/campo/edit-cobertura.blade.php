    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 my-6">
        ...
        <div>
            ...
            <div>
                ...
                <select class="w-full border border-gray-200 rounded-md shadow-sm" wire:model.live="selectedTipo">
            ...
            @if ($selectedTipo == 'efectivas' || $selectedTipo == 'rechazo' || $selectedTipo == 'nadie_en_casa'|| $selectedTipo == 'informante_no_calificado')
                <div class="mt-4 relative mx-auto full">
                    ...
                    <div>
                        <input class="rounded-md border border-gray-300 w-full" wire:model.live.debounce.500ms="searchStickers"
                            type="text" placeholder="Buscar Stickers...">
                        @if ($stickers)
                            <div class="absolute w-full mt-1 hidden z-50 bg-white p-1 rounded-md border border-gray-100 shadow-lg"
            ...
            @endif
            {{-- {{$selectedCertificado ? 'Si' : 'No'}} - {{$selectedSticker ? 'Si' : 'No'}} --}}
        </div>
        <div class="bg-white p-4 rounded-md col-span-1 md:col-span-2">
            <h2 class="text-center font-semibold uppercase">Datos de la asignacion</h2>
            @if ($planning_id && $asignacion_datos)
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mt-4 text-sm">
                    ...
                    <div>
                        <span class="font-semibold">Tipo Sector: </span>{{--  {{$asignacion_datos->tipo_sector}} --}}
