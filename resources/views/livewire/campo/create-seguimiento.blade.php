<div class="max-w-6xl mx-auto p-6">
    ...
    <div>
        ...
        <div class="flex flex-col md:flex-row justify-center md:space-x-6 mt-6">
            ...
            <div class="mb-4 relative mx-auto w-full md:w-56 mt-4 md:mt-0">
                <x-label value="Certificado" />
                <div>
                    <input class="rounded-md border border-gray-300 w-full md:w-56"
                        wire:model.live.debounce.500ms="search" type="text" placeholder="Buscar certificado">
        ...
        <div class="mt-6 bg-white p-6 rounded-md shadow-md">
            <h2 class="text-sm text-center font-medium uppercase">Datos de la Encuesta</h2>
            ...
            @else
                <div class="flex justify-center items-center text-sm h-full">
                    Elegir un Certificado para visualizar datos de la encuesta
                </div>
            @endif
        </div>
