<div>
        ...
        <div class="max-w-7xl mx-auto py-5 px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center">
                ...
                <a class="ml-auto bg-green-600 text-sm text-white px-4 py-2 rounded-md flex items-center"
                    href="{{ route('admin.usuarios.import') }}">
                    <span>
    ...
    <div class="max-w-6xl mx-auto px-4 py-10">
        <div class="mb-4">
            ...
            <x-input type="text" wire:model.live.debounce.500ms="search" class="w-full" placeholder="Ingrese el nombre o cedula del usuario a buscar..." />
        </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach ($usuarios as $user)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">
                                        <a class="bg-blue-500 rounded-full p-2 inline-block" title="Configuracion" href="{{route('admin.edit-asignacion-equipo.edit', $user)}}">
