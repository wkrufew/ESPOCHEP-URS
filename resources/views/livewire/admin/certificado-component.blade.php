    ...
    <div class="py-10 px-4 rounded-md bg-white">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mx-auto">
            ...
            <div class="mb-4 relative mx-auto w-56">
                ...
                <div>
                    <input class="rounded-md border border-gray-300 w-56" wire:model.live.debounce.500ms="search" type="text" placeholder="Buscar Equipos Ejm C4G01">
                        ...
                        <div class="absolute w-56 mt-1 hidden z-50 bg-white p-1 rounded-md border border-gray-100 shadow-lg"
                            ...
                            <ul>
                                @foreach ($equipments as $equipment)
                                    <li x-on:click.away="$wire.open = false" class="hover:bg-green-200 px-1 py-0.5 rounded-md cursor-pointer"
        ...
        <div class="w-full">
            <div class="flex justify-center">
                <p>Equipo seleccionado: <span class="{{ $selectedEquipo ? 'bg-green-500' : 'bg-gray-500' }} text-white px-2 py-1 rounded-full text-sm">
