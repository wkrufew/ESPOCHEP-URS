<div class="max-w-5xl mx-auto p-6 lg:p-8 py-12">
    ...
    <div class="p-6 rounded-md bg-white">
        <h2 class="text-center font-semibold text-xl text-gray-800 leading-tight uppercase">Cambiar Estado de Stickers</h2>
        ...
        <div class="mt-6">
            @if (session()->has('message'))
                @if (session('message') === 'Estado de los stickers actualizado exitosamente.')
