<div class="max-w-7xl mx-auto">
    ...
    <div class="contenedor py-12">
        ...
        <x-form-section submit="save" class="mb-6">
            ...
            <x-slot name="title">
                Agregar una nueva ciudad/canton
            </x-slot>
    
            <x-slot name="description">
                Complete la información necesaria para poder agregar un nueva ciudad/canton
            </x-slot>
        ...
        <x-action-section>
            ...
            <x-slot name="description">
                Aquí encontrará todas los cantones agregadas
            </x-slot>
                        ...
                        @foreach ($cantones as $canton)
                            <tr>
                                <td class="py-2">
                                    ...
                                    <a href="{{route('admin.cantones.show', $canton)}}" class="uppercase underline hover:text-blue-600">
                                        {{$canton->name}}
                                    </a>
                                </td>
                                <td class="py-2">
                                    <div class="flex divide-x divide-gray-300 font-semibold">
                                        <a class="pr-2 hover:text-blue-600 cursor-pointer" wire:click="edit({{$canton}})">Editar</a>
                                        <a class="pl-2 hover:text-red-600 cursor-pointer" wire:click="$dispatch('deleteCanton', {{$canton->id}})">Eliminar</a>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
    ...
    @push('script')
        <script>
            Livewire.on('deleteCanton', cantonId => {
            
                Swal.fire({
                    title: 'Esta seguro?',
                    text: "Este canton se eliminara permanentemente!",
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        ...
                        Livewire.dispatch('canton-delete',  {canton: cantonId} )
