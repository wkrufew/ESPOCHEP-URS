    ...
    <div id="sidebar" class="h-screen w-16 menu bg-white text-white px-4  items-center nunito fixed shadow font-heebo hidden md:flex">
        <ul class="list-reset ">
            <li class="my-2 md:my-0">
                <a href="{{ route('calidad.dashboard') }}" class="{{request()->routeIs('calidad.dashboard') ? 'text-[#60A3BD]' : 'text-gray-600'}} block py-1 md:py-3 pl-1 align-middle text-gray-600 no-underline">
                    <i class="fas fa-chart-area fa-fw mr-3"></i><span class="w-full inline-block pb-1 md:pb-0 text-sm">Inicio</span>
                </a>
                <a href="{{ route('calidad.seguimientos.index') }}"  class=" {{request()->routeIs('calidad.seguimientos.*') ? 'text-[#60A3BD]' : 'text-gray-600'}} block py-1 md:py-3 pl-1 align-middle no-underline">
                    <i class="fas fa-tasks fa-fw mr-3"></i><span class="w-full inline-block pb-1 md:pb-0 text-sm">Seguim/Superv</span>
                </a>
                <li class="my-2 md:my-0 ">
                    <a href="{{ route('calidad.coberturas.equipos') }}"  class=" {{request()->routeIs('calidad.coberturas.equipos') ? 'text-[#60A3BD]' : 'text-gray-600'}} block py-1 md:py-3 pl-1 align-middle no-underline">
        ...
        <nav x-data="{ open: false }" class="sticky top-0 left-0 w-full bg-white border-b border-gray-100 z-50 shadow">
            ...
            <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
                <div class="pt-2 pb-3 space-y-1">
                    ...
                    <x-responsive-nav-link href="{{ route('calidad.seguimientos.index') }}" :active="request()->routeIs('calidad.seguimientos.index')">
                        {{ __('Seguimiento/Supervision') }}
                    </x-responsive-nav-link>                    
                    <x-responsive-nav-link href="{{ route('calidad.coberturas.equipos') }}" :active="request()->routeIs('calidad.coberturas.equipos')">
