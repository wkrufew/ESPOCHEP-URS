    ...
    <div id="sidebar" class="h-screen w-16 menu bg-white text-white px-4  items-center nunito fixed shadow font-heebo hidden md:flex">
        <ul class="list-reset ">
            <li class="my-2 md:my-0">
                <a href="{{ route('socializador.dashboard') }}" class="{{request()->routeIs('socializador.dashboard') ? 'text-[#60A3BD]' : 'text-gray-600'}} block py-1 md:py-3 pl-1 align-middle text-gray-600 no-underline">
                    <i class="fas fa-chart-area fa-fw mr-3"></i><span class="w-full inline-block pb-1 md:pb-0 text-sm">Inicio</span>
                </a>
            </li>
            <li class="my-2 md:my-0 ">
                <a href="{{ route('socializador.index') }}"  class=" {{request()->routeIs('socializador.index') ? 'text-[#60A3BD]' : 'text-gray-600'}} block py-1 md:py-3 pl-1 align-middle no-underline">
                    <i class="fas fa-tasks fa-fw mr-3"></i><span class="w-full inline-block pb-1 md:pb-0 text-sm">Novedades</span>
                </a>
            </li>
        </ul>
    </div>
        ...
        <nav x-data="{ open: false }" class="sticky top-0 left-0 w-full bg-white border-b border-gray-100 z-50 shadow">
            ...
            <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
                <div class="pt-2 pb-3 space-y-1">
                    ...
                    <x-responsive-nav-link href="{{ route('socializador.index') }}" :active="request()->routeIs('socializador.index')">
                        {{ __('Novedades') }}
                    </x-responsive-nav-link>                    
                </div>
